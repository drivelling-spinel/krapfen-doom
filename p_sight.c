...
//-----------------------------------------------------------------------------
//
// $Id: p_sight.c,v 1.2 2000-08-12 21:29:29 fraggle Exp $
//
...
#include "p_setup.h"
#include "m_bbox.h"
#include "doomstat.h" // for demo_compatibility GB 2014
  ...
  for (count = subsectors[num].numlines; --count >= 0; seg++)  // check lines
    {
      ...
      // Who knows why. Exclude test for those. GB 2014 from PrBoom
...
boolean P_CheckSight(mobj_t *t1, mobj_t *t2)
{
  ...
  // same subsector? obviously visible, fron PrBoom GB 2014
